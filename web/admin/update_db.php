...
<script>
    document.getElementById('menu5').classList.remove("menu");
    document.getElementById('menu5').classList.add("menu-open");
    document.getElementById('a23').classList.remove("bg-primary");
    document.getElementById('a23').classList.add("bg-secondary");
</script>
</body>
