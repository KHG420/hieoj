...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <?php echo "<center><h3>$MSG_ADD"."$MSG_CONTEST</h3></center>" ?>;
            ...
            <div class="container-fluid">
                ...
                if(isset($_POST['startdate'])){
                    ...
                    if((function_exists('get_magic_quotes_gpc')&&get_magic_quotes_gpc())){
                        ...
                        $IPprivate = stripslashes($IPprivate);
                    ...
                    $sql = "INSERT INTO `contest`(`title`,`start_time`,`end_time`,`private`,`langmask`,`description`,`password`,`IPprivate`,`team`)
          VALUES(?,?,?,?,?,?,?,?,?)";
                    ...
                    echo $sql.$title.$starttime.$endtime.$private.$langmask.$description.$password.$IPprivate.$team;
                    $cid = pdo_query($sql,$title,$starttime,$endtime,$private,$langmask,$description,$password,$IPprivate,$team) ;
                                ...
                                <tr>
                                    ...
                                    <td height="10px">
                                        <p align=left>
                                            ...
                                            <select name=private style="width:15%;">
                                            ...
                                            <input type=text name=password style="width:15%;" value="">
                                            <?php echo $MSG_CONTEST."-"."访问权限"?>:
                                            <select name=IPprivate style="width:15%;">
                                                <option value=0 <?php echo $IPprivate=='0'?'selected=selected':''?>>都可访问</option>
                                                <option value=1 <?php echo $IPprivate=='1'?'selected=selected':''?>>内网访问</option>
                                                <option value=2 <?php echo $IPprivate=='2'?'selected=selected':''?>>外网访问</option>
                                                <option value=3 <?php echo $IPprivate=='3'?'selected=selected':''?>>断网访问</option>
                                            </select>
                                            <?php echo "比赛类型"?>:
                                            <select name=team style="width:15%;">
                                                <option value=0 <?php echo $team=='0'?'selected=selected':''?>>单人比赛</option>
                                                <option value=1 <?php echo $team=='1'?'selected=selected':''?>>团队比赛</option>
                                            </select>
                                        </p>
                                    </td>
                                </tr>
...
<script>
    ...
    document.getElementById('a19').classList.remove("bg-primary");
    document.getElementById('a19').classList.add("bg-secondary");
</script>
</html>
