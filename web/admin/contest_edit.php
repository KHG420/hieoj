...
if(isset($_POST['startdate'])){
    ...
    $sql = "UPDATE `contest` SET `title`=?,`description`=?,`start_time`=?,`end_time`=?,`private`=?,`langmask`=?,`password`=?,`IPprivate`=?,`team`=? WHERE `contest_id`=?";
    //echo $sql;
    pdo_query($sql,$title,$description,$starttime,$endtime,$private,$langmask,$password,$IPprivate,$team,$cid);
            ...
            <tr>
                ...
                <td height="10px">
                    <p align=left>
                        ...
                        <select name=private style="width:13%;">
                        ...
                        <input type=text name=password style="width:13%;" value='<?php echo htmlentities($password,ENT_QUOTES,'utf-8')?>'>
                        <?php echo $MSG_CONTEST."-"."访问权限"?>:
                        <select name=IPprivate style="width:13%;">
                        ...
                        <?php echo "比赛类型"?>:
                        <select name=team style="width:13%;">
