    ...
    <div class="row">
		...
		<?php  
		    // 如果email填写的是qq邮箱，取QQ头像显示
                ...
                <div class="content">
                    <div class="header"><?php echo htmlentities($nick,ENT_QUOTES,"UTF-8")?></div>
                    <div class="meta">
                        <a class="group"><?php echo htmlentities($school,ENT_QUOTES,"UTF-8")?></a>
                    </div>
                </div>
                                ...
                                <div class="ui grid">
                                    <div class="row">
                                        <div class="column">
                                           ...
                                           <div class="ui bottom attached segment"><?php echo htmlentities($user,ENT_QUOTES,"UTF-8")?></div>
                                        </div>
                                    </div>
                                      <div class="row">
                                          <div class="column">
                                              <h4 class="ui top attached block header">Email</h4>
                                              <div class="ui bottom attached segment" class="font-content"><?php echo htmlentities($email,ENT_QUOTES,"UTF-8")?></div>
                                          </div>
                                      </div>
                                    <div class="row">
                                        <div class="column">
                                            ...
                                            <div class="ui bottom attached segment" class="font-content"><?php echo htmlentities($school,ENT_QUOTES,"UTF-8")?></div>
                                        </div>
                                    </div>
                                    <!-- <div class="row">
                                        <div class="column">
