    ...
    <p id="error_info"></p>
          ...
          <form action="modify.php" method="post" role="form" class="ui form">
                ...
                <div class="field">
                    ...
                    <input disabled name="nick" placeholder="请输入姓名" type="text" value="<?php echo htmlentities($row['nick'],ENT_QUOTES,"UTF-8")?>">
                </div>
                <div class="field">
                ...
                <div class="field">
                    <label for="username">专业班级</label>
                    <input disabled name="school" placeholder="请输入专业班级" type="text" value="<?php echo htmlentities($row['school'],ENT_QUOTES,"UTF-8")?>">
                </div>
                <div class="field">
                    <label for="email">邮箱*&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp(建议改为QQ邮箱)</label>
                    <input name="email" placeholder="请输入邮箱" type="email" value="<?php echo htmlentities($row['email'],ENT_QUOTES,"UTF-8")?>">
                </div>
                <?php if($OJ_VCODE){?>
                  <div class="field">
