    ...
    <div class="row" style="white-space: nowrap;">
      <div class="seven wide column">
        <form action="" method="get">
          <div class="ui search" style="width: 280px; height: 28px; margin-top: -5.3px; float:left">
            <div class="ui left icon input" style="width: 100%;">
              <input class="prompt" style="width: 100%; height: 100%" type="text" value="" placeholder=" <?php echo $MSG_TITLE;?> …" name="search">
        ...
        <form action="problem.php" method="get">
          <div class="ui search" style="width: 120px; height: 0; margin-top: -5.3px;">
            <div class="ui icon input" style="width: 100%;">
              <input class="prompt" style="width: 100%; height: 100%;" type="text" value="" placeholder="ID" name="id">
              <i class="search icon"></i>
            </div>
            <div class="results" style="width: 100%;"></div>
          </div>
      ...
      <div class="nine wide right aligned column">
        <div class="ui toggle checkbox" id="show_tag">
          <p align='left'> <b><?php echo $MSG_SHOW_TAGS;?></b> </p>
