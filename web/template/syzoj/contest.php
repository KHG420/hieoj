        ...
        <div class="row">
            <div class="column">
                <div class="ui buttons">
                    ...
                    <a class="ui small teal button" href="contestrank3.php?cid=<?php echo $view_cid?>">滚榜</a>
                    <a class="ui small purple button" href="contestrank2.php?cid=<?php echo $view_cid?>">Replay</a>
                    <a class="ui small pink button" href="conteststatistics.php?cid=<?php echo $view_cid?>">比赛统计</a>
                    <?php if (isset($_SESSION[$OJ_NAME.'_'.'administrator'])) { ?>
                    <a class="ui small orange button" href="admin/sim_heatmap.php?cid=<?php echo $view_cid?>">查重统计</a>
                    <?php } ?>
                </div>
                              ...
                              echo "<td>".$table_cell."</td>";
                                ...
                                if($table_cell) {
                                    ...
                                    foreach ($cats as $cat) {
                                        ...
                                        $tcolor++;
                                        echo '<a href=problemset.php?search=' . htmlentities($cat, ENT_QUOTES, 'utf-8') . ' class="ui medium '.$label_theme.' label">';
